...
/**
 * Filter the collection by given properties with OR operator.
 *
 * @author Julien RAJERISON <julienrajerison5@gmail.com>
 */
class CustomUserFilter extends AbstractContextAwareFilter implements SearchFilterInterface
{
    ...
    {
        return parent::getManagerRegistry();
    }
    ...
    {
        return parent::normalizePropertyName($property);
    }
}
